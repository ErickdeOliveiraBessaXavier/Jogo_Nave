...
class LevelProgressionController:
    ...
    def _count_active_stage_hostiles(self) -> int:
        ...
        # (Havia aqui uma contagem à parte do MountainPropeller, porque ele vivia
        # numa lista própria fora de `em.enemies` e, sendo o último hostil vivo, a
        # cota "concluía" com a tela ainda ocupada. Ele foi migrado para
        # `em.enemies` e agora entra na contagem geral acima como todos os
        # outros.)
