...
def print_world_summary() -> None:
    ...
    for world in get_all_worlds():
        ...
        logger.info(f"   Níveis: {world.start_level}-{world.end_level} (Total: {world.total_stages})")
        logger.info(f"   Boss: {world.boss_type.__name__ if world.boss_type else 'Procedural'}")
