...
class AirStrikeBomb:
    ...
    def damage_active(self) -> bool:
        return self.state == "exploding" and self.explosion_timer < self.explosion_duration * 0.8
    ...
    def _draw_bomb(self, surface: pygame.Surface) -> None:
        ...
        pygame.draw.circle(glow, (255, 150, 50, 70), 
                          (glow_size // 2, glow_size // 2), glow_size // 2)
        surface.blit(glow, (int(self.x) - glow_size // 2, int(self.y) - glow_size // 2),
        ...
        pygame.draw.polygon(bomb, (255, 180, 50), [(10, 4), (6, 10), (14, 10)])  # Ponta laranja
        ...
        for i in range(3):
            ...
            if y > 0:
                ...
                if size > 2:
                    pygame.draw.circle(s, (255, 220, 100, alpha), (size, size), size // 2)
                surface.blit(s, (int(self.x) - size, int(y) - size),
                            special_flags=pygame.BLEND_RGBA_ADD)
