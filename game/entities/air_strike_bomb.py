...
class AirStrikeBomb:
    ...
    def update(self, dt: float) -> None:
        if self.state == "falling":
            ...
            if not self._fall_sound_played and self.y > 0 and self.x < pygame.display.get_surface().get_width() if pygame.display.get_surface() else 1600:
    ...
    def _draw_bomb(self, surface: pygame.Surface) -> None:
        ...
        for i in range(num_segments):
            ...
            if y_pos > -10:
                ...
                color_index: int = min(int(progress * len(trail_colors)), len(trail_colors) - 1)
        ...
        for i in range(8):
            ...
            if particle_y > -5:
                ...
                s = pygame.Surface((particle_size * 2, particle_size * 3), pygame.SRCALPHA)
                
                # Círculo superior (cabeça da gota)
                pygame.draw.circle(s, color_choice, (particle_size, particle_size), particle_size)
                # Triângulo inferior (cauda da gota)
                pygame.draw.polygon(s, color_choice, [
        ...
        # Círculo superior
        pygame.draw.circle(orange, (*COLOR_ORANGE, 255), (orange_size, orange_size), orange_size)
        # Cauda da gota
        pygame.draw.polygon(orange, (*COLOR_ORANGE, 255), [
        ...
        # Círculo superior
        pygame.draw.circle(yellow, (*COLOR_YELLOW, 255), (yellow_size, yellow_size), yellow_size)
        # Cauda da gota
        pygame.draw.polygon(yellow, (*COLOR_YELLOW, 255), [
        ...
        pygame.draw.circle(white, (255, 255, 200, 255), (white_size, white_size), white_size)
        surface.blit(
            white,
