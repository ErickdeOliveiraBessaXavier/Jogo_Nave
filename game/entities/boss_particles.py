...
class BossParticleSystem:
    ...
    def update_charging_particles(self, dt: float, face_x: float, face_y: float) -> None:
        ...
        for particle in self.charging_particles[:]:
            ...
            distance_to_center = (pygame.Vector2(face_x, face_y) - particle["pos"]).length()
    ...
    def create_circle_disappear_particles(self, center_x: float, center_y: float, radius: float) -> None:
    ...
    def draw_particles(self, surface: pygame.Surface, offset_x: float, offset_y: float) -> None:
    ...
    def draw_circle_disappear_particles(self, surface: pygame.Surface, offset_x: float, offset_y: float) -> None:
        ...
        for particle in self.circle_disappear_particles:
            ...
            surface.blit(particle_surface, (pos_x - int(particle["size"]), pos_y - int(particle["size"])))
