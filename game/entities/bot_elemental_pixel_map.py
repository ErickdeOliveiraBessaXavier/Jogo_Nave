...
PIXEL_MAP: list[list[str | None]] = [
    ...
    [
        ...
        "B",
        "A",
    ],  # linha dos olhos — None = desenhado em _draw_eyes
    [
        "A",
        "B",
        "D",
...
# ──────────────────────────────────────────────────────────────────
# PALETA BASE (neutro)
# Valores espelham o :root CSS do arquivo HTML de referência.
# ──────────────────────────────────────────────────────────────────

C: dict[str, Tuple[int, int, int]] = {
    # Corpo neutro
    "A": (11, 12, 16),  # contorno / sombra profunda  → --robot-outline-neutral: #0b0c10
    "B": (58, 79, 99),  # corpo escuro (borda)        → --robot-body-neutral:    #3a4f63
    "C": (74, 90, 104),  # haste antena                → #4a5a68
    "D": (58, 79, 99),  # interior do corpo (= B neutro; efeito dark/light gerado
    #                   proceduralmente em _draw_body)
    "E": (142, 158, 171),  # topo antena (mais claro)    → #8e9eab
    # Cores neutras de corpo derivadas do HTML — usadas em reset e __init__
    "DARK_NEUTRAL": (38, 52, 66),  # --robot-dark-neutral:  #263442
    "LIGHT_NEUTRAL": (99, 122, 140),  # --robot-light-neutral: #637a8c
    ...
    # Reflexo / brilho do olho e da antena
    "PUPIL": (255, 255, 255),
}

# Paletas completas por ataque — espelham o JS applyPalette()
ATTACK_PALETTES: dict[str, dict[str, Tuple[int, int, int]]] = {
    "inferno": {
        ...
        "body_outline": (61, 20, 0),  # #3d1400
        "body_main": (94, 71, 62),  # #5e473e
        "body_dark": (66, 48, 42),  # #42302a
        "body_light": (138, 108, 98),  # #8a6c62
...
# Cor neutra do propulsor (fora de ataque) — espelha :root do HTML
