    ...
    def update(self, dt: float) -> None:
        ...
        if self.state == 'alive':
            if self.timer >= self.lifetime:
                ...
                if line_length > 0: line_vec.normalize_ip()
                ...
                for i in range(num_particles_along_line):
                    ...
                    for _ in range(2):
                        particle: DeathParticle = {
                            ...
                            'color': random.choice([(255, 255, 200), (255, 220, 150), (255, 255, 255)]),
    ...
    def draw(self, surface: pygame.Surface) -> None:
        if self.state == 'alive' and self.w > 0:
            ...
            if line_width > 0:
                ...
                pygame.draw.line(surface, glow_color, start_point, end_point, line_width + 6)

            # Núcleo do raio (linha sólida)
            pygame.draw.line(surface, (255, 255, 255), start_point, end_point, line_width)
