...
**Wingman** (`entities/player/wingman.py`), no **auto-aim do MiniShip** e no
**HOMING_SHOT** (`entities/projectiles/homing_bullet.py`).
...
quando `dead`. Padrão de referência: `entities/player/wingman.py::_target_center`.
